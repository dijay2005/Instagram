...
public class GlobalMenuAdapter extends ArrayAdapter<GlobalMenuAdapter.GlobalMenuItem>
{
    ...
    private void setupMenuItems()
    {
        ...
        menuItems.add(new GlobalMenuItem(R.drawable.ic_global_menu_nearby, "Photo Nearby"));
        menuItems.add(new GlobalMenuItem(R.drawable.ic_global_menu_likes, "Photo You've Liked"));
        menuItems.add(GlobalMenuItem.dividerMenuItem());
        menuItems.add(new GlobalMenuItem(0, "Setting"));
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            return inflater.inflate(R.layout.item_menu_driver, parent, false);
        }
    }
